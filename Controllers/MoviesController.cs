...
namespace MvcMovie8.Controllers
{
    public class MoviesController : Controller
    {
        private readonly MvcMovie8Context _context;

        public MoviesController(MvcMovie8Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,ReleaseDate,Price,GenreId")] Movie movie)
        {
